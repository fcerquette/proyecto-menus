  ...
  <el-row>
    ...
    <el-col :span="8"
      ><div>
        ...
        <el-button style="margin-top:30px" @click="createRoot()"
          >Crear Menu</el-button
        >
        <el-tree
          :data="menu"
          :props="defaultProps"
        ...
        >
          <span class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <span>
              <el-button type="text" size="mini" @click="addMenu(node, data)">
                Agregar
              </el-button>
              <el-button type="text" size="mini" @click="editMenu(node, data)">
                Editar
              </el-button>
              <el-button
                type="text"
